...
export default function DashboardPage() {
  ...
  const modules = [
    ...
    },
    {
      ...
      description: "Explore the state of the world just before the emergence of Islam.",
      progress: 100,
      completed: true,
    ...
    },
    {
      ...
      description: "Learn about the life and mission of the final Messenger of God.",
      progress: 75,
      completed: false,
      lastAccessed: "Today",
    },
    {
      ...
      description: "Study the life and caliphate of the first successor to the Prophet Muhammad ﷺ.",
      progress: 30,
      completed: false,
      lastAccessed: "Today",
    },
    {
      id: "umar-just",
      title: "Umar the Just",
      description: "Explore the life and achievements of the second caliph of Islam.",
      progress: 0,
      completed: false,
  ...
  const activities = [
    { id: 1, action: "Completed module", target: "Introduction & Overview", date: "3 days ago" },
    { id: 2, action: "Completed quiz", target: "Introduction & Overview", date: "3 days ago" },
    { id: 3, action: "Started module", target: "The World at The Advent of Islam", date: "2 days ago" },
    { id: 4, action: "Completed module", target: "The World at The Advent of Islam", date: "Yesterday" },
    { id: 5, action: "Completed quiz", target: "The World at The Advent of Islam", date: "Yesterday" },
    { id: 6, action: "Started module", target: "The Prophet Muhammad ﷺ", date: "Today" },
    { id: 7, action: "Completed quiz", target: "The Prophet Muhammad ﷺ", date: "Today" },
    { id: 8, action: "Started module", target: "Abu Bakr The Truthful", date: "Today" },
  ]
  ...
  const recommendations = {
    ...
    nextModule: {
      id: "umar-just",
      title: "Umar the Just",
      reason: "Based on your progress, this is the next logical module to continue your learning journey.",
    },
  }
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground mt-2">
              {userData.completedModules} of {userData.totalModules} modules completed
            </p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent className="flex items-center">
            ...
            <div>
              <div className="text-2xl font-bold">{userData.learningStreak} days</div>
              <p className="text-xs text-muted-foreground">Last active: {userData.lastActive}</p>
            </div>
          </CardContent>
        </Card>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-8">
                    ...
                    <CardContent className="p-4 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                      ...
                      <div className="flex flex-col items-end gap-2 min-w-[120px]">
                        ...
                        <Link href={`/modules/${module.id}`} className="mt-2">
                          <Button size="sm">{module.progress > 0 ? "Continue" : "Start"}</Button>
                        </Link>
                      </div>
                    </CardContent>
                  </Card>
                    ...
                    <CardContent className="p-4 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                      ...
                      <div className="flex flex-col items-end gap-2">
                        <div className="flex items-center">
                          <span className="text-lg font-bold mr-2">{quiz.score}%</span>
                ...
                <CardContent className="p-4">
                  <ul className="space-y-4">
                    {activities.map((activity) => (
                      <li key={activity.id} className="flex items-start gap-3 pb-4 border-b last:border-0">
        ...
        <div>
          <h2 className="text-xl font-bold mb-4">AI Learning Recommendations</h2>
