...
export default function WorldAdventIslamAssessment() {
  ...
  const questions: QuizQuestion[] = [
    ...
    {
      slug: "economies-of-the-muslim--christian-worlds",
      question: "Which cities were major trade centers in the Islamic world?",
      options: [
        "London, Paris, Rome",
    ...
    },
    {
      slug: "economies-of-the-muslim--christian-worlds",
      question:
        "True or False: The Muslim world had a banking system that used letters of credit (sakk).",
      options: ["True", "False"],
      type: "single",
      correctAnswer: "True",
    },
    {
      slug: "economies-of-the-muslim--christian-worlds",
      question:
        "Which of the following crops were introduced by Muslim farmers?",
      options: [
        "Corn, wheat, potatoes",
        "Sugarcane, citrus fruits, cotton, rice",
        "Apples, grapes, olives",
        "None of the above",
      ],
      type: "single",
      correctAnswer: "Sugarcane, citrus fruits, cotton, rice",
    },
    {
      slug: "economies-of-the-muslim--christian-worlds",
      question:
    ...
    },
    {
      slug: "economies-of-the-muslim--christian-worlds",
      question:
        "Which of the following were major industries in the Muslim world? (Select all that apply)",
      options: [
        "Textile production",
        "Metalwork",
        "Glassmaking",
    ...
    return (
      <div className="container mx-auto px-4 py-8">
        <div className="flex items-center gap-2 mb-6">
          <Link href="/modules/economies-of-the-muslim--christian-worlds/7higher">
