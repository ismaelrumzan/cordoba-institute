...
export default function WorldAdventIslamAssessment() {
  ...
  const questions = [
    {
      question: "Which two great empires dominated the world at the time of the Prophet Muhammad ﷺ?",
      options: [
        "The Chinese Empire and the Indian Empire",
        "The Eastern Roman Empire and the Persian Empire",
        "The Egyptian Empire and the Babylonian Empire",
        "The Greek Empire and the Mongol Empire",
      ],
      correctAnswer: "The Eastern Roman Empire and the Persian Empire",
    },
    {
      question: "What religion had the Roman Empire embraced as its official religion in the 4th century?",
      options: ["Judaism", "Islam", "Christianity", "Zoroastrianism"],
      correctAnswer: "Christianity",
    },
    {
      question: "What was the religion followed by the Persians during the time of the Prophet Muhammad ﷺ?",
      options: ["Christianity", "Buddhism", "Zoroastrianism", "Hinduism"],
      correctAnswer: "Zoroastrianism",
    },
    {
      question: "What term did the Romans use to refer to the nomadic people living outside the 'civilized' world?",
      options: ["Savages", "Barbarians", "Outsiders", "Nomads"],
      correctAnswer: "Barbarians",
    },
    {
      question:
        "According to the Quran, how well did the People of the Book (Jews and Christians) know the final Prophet?",
      options: [
        "They had no knowledge of him",
        "They knew him like they knew their own sons",
        "They had vague prophecies about him",
        "They rejected all prophecies about him",
      ],
      correctAnswer: "They knew him like they knew their own sons",
    },
  ]
    ...
    return (
      <div className="container mx-auto px-4 py-8">
        <div className="flex items-center gap-2 mb-6">
          ...
          <h1 className="text-2xl font-bold">The World at The Advent of Islam - Assessment</h1>
        </div>
        ...
        <div className="lg:col-span-2">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Test your knowledge about the world at the advent of Islam</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="mb-6">
                <div className="flex justify-between text-sm mb-1">
